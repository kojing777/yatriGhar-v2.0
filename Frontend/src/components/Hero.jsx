...
const Hero = () => {
  ...
  return (
    <div className='flex flex-col items-start justify-center px-6 md:px-16 lg:px-24 xl:px-32 text-white bg-[url("/src/assets/hikee.jpg")] bg-no-repeat bg-cover bg-center h-screen'>
      <p className="bg-[#1E6F45] px-3.5 py-1 rounded-full mt-20">
